...
namespace Creator.Migrations
{
    ...
    [Migration("20170517021759_initial")]
    partial class initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Creator.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Creator.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("Creator.Models.Comment", b =>
                {
                    b.HasOne("Creator.Models.ApplicationUser", "CommentOwner")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Creator.Models.ApplicationUser")
                        .WithMany("Claims")
